...
- [x] 1. Narzedzia ltree i rozszerzenia typow
  - [x] 1.1 Utworz src/lib/utils/ltree.ts z funkcjami pathToLtree i ltreeToPath
  ...
  - [x] 1.2 Rozszerz src/lib/db/types.ts o nowe interfejsy i typy
  ...
  - [x] 1.3 Rozszerz src/lib/sync/types.ts - zaktualizuj typ Entity
    - Zmien Entity z 'resource' | 'event' na 'resource' | 'event' | 'workspace' | 'workspace_membership'
    - _Requirements: 7.3, 10.5_

- [x] 2. Migracja SQLite - schemat i dane
  - [x] 2.1 Zaktualizuj src/lib/db/schema.ts - dodaj nowe tabele i zmodyfikuj istniejace
  ...
  - [x] 2.2 Zaktualizuj src/lib/db/connection.ts - dodaj logike migracji Fazy 5
...
- [x] 3. Migracja Postgres
  - [x] 3.1 Utworz supabase/migrations/20260601000001_multi_tenant_schema.sql
  ...
  - [x] 3.2 Dodaj funkcje is_workspace_member i polityki RLS do migracji
...
- [x] 5. Zapytania workspace - warstwa danych
  - [x] 5.1 Utworz src/lib/db/workspaceQueries.ts z funkcjami CRUD workspace
...
- [x] 6. Rozszerzenia sync - worker i pull
  - [x] 6.1 Zaktualizuj src/lib/sync/worker.ts - obsluga encji workspace
  ...
  - [x] 6.2 Zaktualizuj src/lib/sync/pull.ts - pobieranie workspace'ow przed resources/events
...
- [x] 8. Integracja workspace_id z istniejacymi queries i store
  - [x] 8.1 Zaktualizuj src/lib/db/queries.ts - dodaj workspace_id do mutacji resources i events
  ...
  - [x] 8.2 Zaktualizuj src/store/projects.ts - przekaz activeWorkspaceId do zapytan
    - Pobierz activeWorkspaceId z WorkspaceStore w metodzie refresh()
    - Przekaz workspaceId do listActiveResources i createResource
    - _Requirements: 4.5_

- [x] 9. WorkspaceStore
  - [x] 9.1 Utworz src/store/workspace.ts - Zustand store zarzadzajacy workspace'ami
  ...
  - [x] 9.2 Zainicjalizuj WorkspaceStore w src/main.tsx
...
- [x] 11. Komponenty UI - Workspace
  - [x] 11.1 Utworz src/components/Workspace/WorkspaceCreateModal.tsx
  ...
  - [x] 11.2 Utworz src/components/Workspace/WorkspaceSwitcher.tsx
  ...
  - [x] 11.3 Utworz src/components/Workspace/WorkspaceSettingsPanel.tsx
  ...
  - [x] 11.4 Utworz src/components/Workspace/InviteAcceptView.tsx
...
- [x] 12. Integracja w App.tsx
  - [x] 12.1 Dodaj WorkspaceSwitcher do headera w src/App.tsx
...
- [x] 14. Testy
  - [x]* 14.1 Napisz property test dla round-trip konwersji ltree (src/lib/utils/__tests__/ltree.test.ts)
  ...
  - [x]* 14.2 Napisz property test dla poprawnosci pathToLtree (src/lib/utils/__tests__/ltree.test.ts)
  ...
  - [x]* 14.3 Napisz property test dla odrzucania niepoprawnych danych (src/lib/utils/__tests__/ltree.test.ts)
  ...
  - [x]* 14.4 Napisz property test dla walidacji nazwy workspace (src/store/__tests__/workspace.test.ts)
  ...
  - [x]* 14.6 Napisz property test dla LWW merge workspace'ow (src/lib/sync/__tests__/merge.test.ts)
  ...
  - [x]* 14.7 Napisz property test dla konwersji znacznikow czasu workspace (src/lib/sync/__tests__/worker.test.ts)
  ...
  - [x]* 14.8 Napisz property test dla collapse duplikatow workspace w outbox (src/lib/sync/__tests__/worker.test.ts)
...
- [x] 15. Finalne testy i dokumentacja
  - [x] 15.1 Zaktualizuj CLAUDE.md - dodaj notatki o Fazie 5
